...
this.add.line(0, 0, graphMarginX, graphMarginY +30, graphMarginX, baseY + 5, 0x000000).setLineWidth(2);

// X-axis (horizontal, aligned straight at baseY)
this.add.line(0, 0, graphMarginX + 15, baseY, graphMarginX + graphWidth + 10, baseY, 0x000000).setLineWidth(2);
